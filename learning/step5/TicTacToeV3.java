...
public class TicTacToeV3 {
    ...
    public static void main(String[] args) {
        ...
        for (int turn = 0; turn < 9; turn++) {
            ...
            System.out.println("---------------");
            // Проверка победы
            boolean userWin = false, computerWin = false;
            for (int[] line : winLines) {
                int r1=line[0],c1=line[1],r2=line[2],c2=line[3],r3=line[4],c3=line[5];
                if (gameField[r1][c1] == userSymbol && gameField[r2][c2] == userSymbol && gameField[r3][c3] == userSymbol) userWin = true;
                if (gameField[r1][c1] == computerSymbol && gameField[r2][c2] == computerSymbol && gameField[r3][c3] == computerSymbol) computerWin = true;
            }
            if (userWin) { System.out.println("Вы победилитупую машину!"); break; }
            if (computerWin) { System.out.println("Тупая машина победила!"); break; }
            if (turn == 8) System.out.println("Ничья!");
        }
        scanner.close();
    }
}